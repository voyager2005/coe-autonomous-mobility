...
def load_embedder_ckpt_with_optim(device, args, combine_type = ['clear', 'low', 'haze', 'blur', 'noise', 'low_haze', 'low_blur', 'low_noise', 'haze_blur', 'haze_noise', 'low_haze_blur', 'low_haze_noise', 'low_haze_blur_noise']):
    print('Init embedder')
    # seed
    if args.seed == -1:
